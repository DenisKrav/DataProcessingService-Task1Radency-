...
{
    internal class CSVReader : IReaderFiles
    {
        ...
        public void SeveJSON(List<City> cities)
        {
            ...
            // Записуємо у файл
            File.WriteAllTextAsync(ConfigurationManager.AppSettings.Get("FolderBPath") + $"/output{MetaFileData.Parsed_files}.json", json);
